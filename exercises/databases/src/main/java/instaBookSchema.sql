...
INSERT INTO Profiles(FirstName,LastName,UserHandle,EmailAddress,Description,Picture) VALUES('serena','williams','serenawilliams','serena@tennis.com','I''m Olympia''s mom. @serena ships WORLDWIDE www.serenawilliams.com','serena.jpg');
INSERT INTO Profiles(FirstName,LastName,UserHandle,EmailAddress,Description,Picture) VALUES('Beyoncé','Giselle Knowles-Carter','beyoncé','bey@sashafierce.com','tiny.cc/6y3mnz','beyonce.png');
INSERT INTO Profiles(FFirstName,LastName,UserHandle,EmailAddress,Description,Picture) VALUES('Jane','Doe','janedow','janedoe@gmail.com',NULL,NULL);
